...
class Vertice {
	...
	bool used;
public:
	Vertice() : data(V()), dijkstra_len(INT32_MAX), used(false), topo_idx(-1), scc_number(0), bellman_len(100000000.0), warshall_len(100000000.0) {};
	Vertice(const V& data_) : data(data_), dijkstra_len(INT32_MAX), used(false), topo_idx(-1), scc_number(0), 
		bellman_len(100000000.0), warshall_len(100000000.0) {};
